                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex-1">
                        ...
                        <div className="space-y-1">
                          ...
                          {issue.issuedTo && (
                            <p className="text-sm text-secondary-600">
                              <span className="font-medium">Issued To:</span> {issue.issuedTo}
                            </p>
                          )}
                          {issue.remarks && (
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                <Select id="toolId" {...register('toolId', { valueAsNumber: true })} className="mt-1">
                  <option value="">Select a tool</option>
                  {availableTools && Array.isArray(availableTools) && availableTools.map((tool) => (
              ...
              <div>
                ...
                <Select id="divisionId" {...register('divisionId', { valueAsNumber: true })} className="mt-1">
                  <option value="">Select a division</option>
                  {activeDivisions && Array.isArray(activeDivisions) && activeDivisions.map((division) => (
            ...
            <div>
              ...
              <Textarea id="remarks" {...register('remarks')} className="mt-1" rows={4} />
            </div>
